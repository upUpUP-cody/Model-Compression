"""Run P1.2 studies across multiple seeds and optional compression targets."""
...
from experiments.run_p12_comparison import run_study, run_test_report
    ...
    for target in targets:
        for seed in seeds:
            ...
            if target is not None:
                ...
                config["run_label"] = f"{config.get('run_label', 'p12')}_{label}"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run P1.2 studies across seeds and compression targets")
    parser.add_argument("--config", default="configs/mnist_p12_gpu_multiseed.yaml")
