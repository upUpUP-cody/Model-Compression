"""Compatibility shim: loads archive/experiments_legacy/run_cifar_p12_comparison.py as experiments.run_cifar_p12_comparison."""
...
_NAME = "experiments.run_cifar_p12_comparison"
_LEGACY = Path(__file__).resolve().parents[1] / "archive" / "experiments_legacy" / "run_cifar_p12_comparison.py"
