"""Compatibility shim: loads archive/experiments_legacy/run_cifar_recovery_ablation.py as experiments.run_cifar_recovery_ablation."""
...
_NAME = "experiments.run_cifar_recovery_ablation"
_LEGACY = Path(__file__).resolve().parents[1] / "archive" / "experiments_legacy" / "run_cifar_recovery_ablation.py"
